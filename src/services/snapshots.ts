      ...
      await client.query(
        `
          ...
          on conflict (card_id, snapshot_date) do update set
            ...
            active_ask_low = excluded.active_ask_low,
            active_ask_high = excluded.active_ask_high,
            active_ask_reference = excluded.active_ask_reference,
            active_ask_seller_count = excluded.active_ask_seller_count,
        ...
        [
          ...
          snapshot.activeAskLow,
          snapshot.activeAskHigh,
          snapshot.activeAskReference,
          snapshot.activeAskSellerCount,
      ...
      await client.query(
        `
          insert into signals_daily (
            ...
            max_buy_price,
            target_net_roi_pct,
            primary_exit_channel,
            exit_scenarios,
            liquidity_score,
            liquidity_confidence_score,
            liquidity_tier,
            collector_discount_pct,
            target_buy_80,
            target_buy_85,
            target_buy_90,
          ...
          on conflict (card_id, signal_date) do update set
            ...
            estimated_net_exit = excluded.estimated_net_exit,
            max_buy_price = excluded.max_buy_price,
            target_net_roi_pct = excluded.target_net_roi_pct,
            primary_exit_channel = excluded.primary_exit_channel,
            exit_scenarios = excluded.exit_scenarios,
            liquidity_score = excluded.liquidity_score,
            liquidity_confidence_score = excluded.liquidity_confidence_score,
            liquidity_tier = excluded.liquidity_tier,
            collector_discount_pct = excluded.collector_discount_pct,
        ...
        [
          ...
          signal.signalDate,
          signal.marketNow,
          signal.activeAskReference,
          signal.expectedSalePrice,
          signal.estimatedNetExit,
          signal.maxBuyPrice,
          signal.targetNetRoiPct,
          signal.primaryExitChannel,
          JSON.stringify(signal.exitScenarios),
          signal.liquidityScore,
          signal.liquidityConfidenceScore,
          signal.liquidityTier,
          signal.collectorDiscountPct,
          signal.targetBuy80,
          signal.targetBuy85,
          signal.targetBuy90,
